...
from Setting import SCREEN_HEIGHT,SCREEN_WIDTH,FPS,THRESHOLD,SCREEN_SCROLL,BG_SCROLL,ROWS,COLS,TILETYPES,TILESIZE,level,moving_left,moving_right,jump,grenade
from loadimages import pine1,pine2,mountain,cloud,skyimage,bullet_img,grenade_img,ammo_box,grenade_box,health_box,image_list
